...
DEFINE_string(VOCAB, "/home/david/code/aru-core/src/ORBvoc.txt", "path to ORB vocab file");
DEFINE_string(VO_CONFIG, "/home/david/code/aru_sil_py/navigation/config/ZED_vo_config.yaml", "path to VO Config file");
DEFINE_string(IMAGE_LEFT, "/home/david/data/Husky_Bags/lab/2022-07-04-10-28-32/log/white_lab_2_left.monolithic ", "path to Image left monolithic file");
DEFINE_string(IMAGE_RIGHT, "/home/david/data/Husky_Bags/lab/2022-07-04-10-28-32/log/white_lab_2_right.monolithic", "path to Image right monolithic file");
DEFINE_string(VO_MONO, "/home/david/data/vo.monolithic", "path to VO output monolithic file");
