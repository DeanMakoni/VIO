...
class Layer {
 public:
  ...
  explicit Layer(const datatype::mapping::pbVoxelLayer& proto);
  ...
  // Serialization tools.
  void getProto(datatype::mapping::pbVoxelLayer* proto) const;
  bool isCompatible(const datatype::mapping::pbVoxelLayer& layer_proto) const;
  bool isCompatible(const datatype::mapping::pbVoxelBlock& layer_proto) const;
  ...
  bool addBlockFromProto(const datatype::mapping::pbVoxelBlock& block_proto,
