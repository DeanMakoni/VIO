...
class Block {
 public:
  ...
  explicit Block(const datatype::mapping::pbVoxelBlock& proto);
  ...
  // Serialization.
  void getProto(datatype::mapping::pbVoxelBlock* proto) const;
 ...
 private:
  void deserializeProto(const datatype::mapping::pbVoxelBlock& proto);
  void serializeProto(datatype::mapping::pbVoxelBlock* proto) const;
