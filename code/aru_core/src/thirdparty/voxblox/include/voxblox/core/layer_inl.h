...
Layer<VoxelType>::Layer(const datatype::mapping::pbVoxelLayer& proto)
...
template <typename VoxelType>
void Layer<VoxelType>::getProto(datatype::mapping::pbVoxelLayer* proto) const {
  CHECK_NOTNULL(proto);
...
bool Layer<VoxelType>::saveSubsetToFile(const std::string& file_path,
  ...
  datatype::mapping::pbVoxelLayer proto_layer;
...
bool Layer<VoxelType>::saveBlocksToStream(bool include_all_blocks,
  ...
  for (const BlockMapPair& pair : block_map_) {
    ...
    if (write_block_to_file) {
      datatype::mapping::pbVoxelBlock block_proto;
...
template <typename VoxelType>
bool Layer<VoxelType>::addBlockFromProto(const datatype::mapping::pbVoxelBlock&
                                             block_proto,
...
template <typename VoxelType>
bool Layer<VoxelType>::isCompatible(const datatype::mapping::pbVoxelLayer& layer_proto) const {
...
template <typename VoxelType>
bool Layer<VoxelType>::isCompatible(const datatype::mapping::pbVoxelBlock&
                                        block_proto) const {
  bool compatible = true;
